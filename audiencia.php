...
<section class="ms-5 mt-5 p-4">
  ...
  <div class="row">
    <div class="container">
      <div class="btnAdd">
        <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal" class="btn btn-outline-success">Cadastrar</a>
        <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal" class="btn btn-outline-primary">imprimir</a>
      </div>
      <div class="row">
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#example').DataTable({
      ...
      'order': [],
      'ajax': {
        'url': 'views/audiencia/fetch_data.php',
        'type': 'post',
      },
      "aoColumnDefs": [{
          "bSortable": false,
  ...
  $(document).on('submit', '#addUser', function(e) {
    ...
    if (city != '' && username != '' && mobile != '' && email != '') {
      $.ajax({
        url: "views/audiencia/add_user.php",
        type: "post",
        data: {
          city: city,
          username: username,
  ...
  $(document).on('submit', '#updateUser', function(e) {
    ...
    if (city != '' && username != '' && mobile != '' && email != '') {
      $.ajax({
        url: "views/audiencia/update_user.php",
        type: "post",
        data: {
          city: city,
          username: username,
  ...
  $('#example').on('click', '.editbtn ', function(event) {
    ...
    $.ajax({
      url: "views/audiencia/get_single_data.php",
      data: {
        id: id
      },
      type: 'post',
  ...
  $(document).on('click', '.deleteBtn', function(event) {
    ...
    if (confirm("Are you sure want to delete this User ? ")) {
      $.ajax({
        url: "views/audiencia/delete_user.php",
        data: {
          id: id
        },
        type: "post",
