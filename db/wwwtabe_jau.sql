...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08/06/2023 às 02:24
...
CREATE TABLE `audiencia` (
  ...
  `pastor` varchar(40) DEFAULT NULL,
  `estado` varchar(100) DEFAULT NULL,
  `cidade` varchar(50) NOT NULL,
  `pais` varchar(60) NOT NULL DEFAULT 'Brasil',
  `nmr` int(4) DEFAULT NULL,
  `data` varchar(20) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Despejando dados para a tabela `audiencia`
--

INSERT INTO `audiencia` (`id`, `tipo`, `nome`, `pastor`, `estado`, `cidade`, `pais`, `nmr`, `data`) VALUES
(5236, '', 'NOEMI MOREIRAdddd', 'D', '26', 'ADOLFO', 'Brasil', 2, '2023-06-07 16:58:28'),
(5237, '', 'gsfgfdsgsfdgsfgsfdg', 'D', '3', 'ALVARÃES', 'Brasil', 3, '2023-06-07 20:15:27');
...
--
-- Estrutura para tabela `config_player`
--

CREATE TABLE `config_player` (
  `id` int(11) NOT NULL,
  `url` varchar(300) DEFAULT NULL,
  `file` varchar(50) DEFAULT NULL,
  `exibir` enum('S','N') DEFAULT NULL,
  `tipo` enum('offline','saopedro','jau','youtube','americo') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Despejando dados para a tabela `config_player`
--

INSERT INTO `config_player` (`id`, `url`, `file`, `exibir`, `tipo`) VALUES
(1, '', '', NULL, 'offline');
...
CREATE TABLE `hymns` (
  ...
  `third` enum('true','false') DEFAULT NULL,
...
--
-- Despejando dados para a tabela `hymns`
--

INSERT INTO `hymns` (`id`, `cantor`, `cidade`, `pastor`, `third`, `titulo`, `created_at`, `updated_at`) VALUES
(20, 'ELIEL', 'ELIEL', 'ELIEL', '', 'ELIEL', '2023-06-07 20:02:29', NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `motivos_oracao`
--

CREATE TABLE `motivos_oracao` (
  `id` int(11) NOT NULL,
  `descricao` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

--
-- Despejando dados para a tabela `motivos_oracao`
--

INSERT INTO `motivos_oracao` (`id`, `descricao`) VALUES
(12, 'Cura de enfermidade'),
...
(20, 'Viagem'),
(21, 'Agradecimento'),
(22, 'Vai realizar uma prova'),
(23, 'Causa na Justiça'),
(24, 'Deus sabe o motivo'),
(25, 'Porta de Emprego'),
(26, 'Vai passar por exames médicos'),
(27, 'Vai passar por cirurgia'),
(28, 'Recuperação de Saúde');
...
CREATE TABLE `oracao` (
  ...
  `mens_dest` varchar(240) DEFAULT NULL,
  `motivo_oracao` int(10) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `oracao` (`id`, `tipo`, `nome`, `cidade`, `estado`, `data`, `mens_dest`, `motivo_oracao`) VALUES
(2818, 0, 'NOEMI MOREIRA', 'ITUVERAVA', '26', '2023-06-07 17:04:16', '', 12),
(2819, 0, 'ELIEL M OLIVEIRA', 'JAÚ', '26', '2023-06-07 17:04:38', '', 17),
(2820, 0, 'ISAIS MATEUS', 'UBERABA', '11', '2023-06-07 17:04:59', '', 22),
(2821, 0, 'KEILA MARINS', 'FLORIANÓPOLIS', '24', '2023-06-07 17:05:41', '', 24),
(2822, 0, 'FULANO DE TAL', 'ÁGUA BRANCA', '2', '2023-06-07 17:17:06', '', 17),
(2823, 0, 'BELTRO', 'ABDON BATISTA', '24', '2023-06-07 17:17:15', '', 17),
(2824, 0, 'OSMAR DA TERRA', 'ABDON BATISTA', '24', '2023-06-07 17:17:26', '', 17);
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Países e Nações';
...
(1, 'Eliel', 'elielmatheuss@hotmail.com', NULL, '123', NULL, '2023-05-26 06:10:36', '2023-05-26 06:10:36');
...
--
-- Índices de tabela `config_player`
--
ALTER TABLE `config_player`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `hymns`
--
ALTER TABLE `hymns`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `motivos_oracao`
--
ALTER TABLE `motivos_oracao`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `config_player`
--
ALTER TABLE `config_player`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `hymns`
--
ALTER TABLE `hymns`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de tabela `motivos_oracao`
--
ALTER TABLE `motivos_oracao`
...
--
ALTER TABLE `oracao`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2826;
